...
type NodeUnitInterface interface {
	Create(ctx context.Context, nodeUnit *v1.NodeUnit, opts metav1.CreateOptions) (*v1.NodeUnit, error)
	Update(ctx context.Context, nodeUnit *v1.NodeUnit, opts metav1.UpdateOptions) (*v1.NodeUnit, error)
	UpdateStatus(ctx context.Context, nodeUnit *v1.NodeUnit, opts metav1.UpdateOptions) (*v1.NodeUnit, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*v1.NodeUnit, error)
	List(ctx context.Context, opts metav1.ListOptions) (*v1.NodeUnitList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.NodeUnit, err error)
	NodeUnitExpansion
}
...
func (c *nodeUnits) List(ctx context.Context, opts metav1.ListOptions) (result *v1.NodeUnitList, err error) {
...
func (c *nodeUnits) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nodeUnits) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
