...
import (
	...
	"github.com/attlee-wang/sites-manager/pkg/util/site/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*SiteV1Client, error) {
	config := *c
	...
	return &SiteV1Client{client}, nil
}

// NewForConfigOrDie creates a new SiteV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *SiteV1Client {
...
// New creates a new SiteV1Client for the given RESTClient.
func New(c rest.Interface) *SiteV1Client {
	return &SiteV1Client{c}
}
...
func (c *SiteV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
